...
var instanceMethods = {
	...
	, process: function(callback) {
		return process(this, this._value);
	}
};
	...
	if( !any ) {
		...
		mix( any.prototype, {
			...
			, value: function(value) {
				...
				value = validator.exists(value) ? value : self.getDefault();
				self._value = self.process( (typeof any.from == "function") ? any.from( value ) : value );
				return self;
			}
		} );
